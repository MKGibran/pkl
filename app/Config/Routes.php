...
$routes->group("staff", ["filter" => "auth"], function ($routes) {
    ...
    $routes->get('gudang/permintaanBarang', 'Staff\BarangController::permintaanBarang');
    $routes->get('gudang/edit/(:num)', 'Staff\BarangController::ubah/$1');
    $routes->get('gudang/detail/(:num)', 'Staff\BarangController::detail/$1');
    $routes->delete('gudang/delete/(:num)', 'Staff\BarangController::hapus/$1');
    $routes->match(['post'],'/gudang/store/', 'Staff\BarangController::tambah');
    $routes->get('/gudang/pengembalian/(:num)', 'Staff\BarangController::pengembalian/$1');
});
// Manager routes
