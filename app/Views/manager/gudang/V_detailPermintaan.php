                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <a type="button" class="btn btn-rounded mx-1 btn-warning disabled" href="<?= base_url('Manager/BarangController/ubahDetailBarang')?>/<?= $brg['id']; ?>">
                        <i class="mdi mdi-pencil"></i></a>
                        <a type="button" class="btn btn-rounded mx-1 btn-danger disabled" href="<?= base_url('Manager/BarangController/hapusDetailBarang')?>/<?= $brg['id']; ?>">
                        <i class="bi bi-trash"></i></a>
                        <?php endif ?>
                      </td>
                    </tr>
