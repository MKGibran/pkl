      ...
      <div class="modal-body">
        <form class="forms-sample" action="<?= base_url('Profile/editData') ?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input name="phone" type="tel" class="form-control" pattern="[0-9]{10,12}" title="Harus berupa angka dari 10 hingga 12 digit" value="<?= $user[0]['phone']; ?>" id="exampleInputPhone" placeholder="<?= $user[0]['phone']; ?>">
          </div>
          <div class="form-group">
