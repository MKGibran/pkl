...
<head>
  ...
  <title>Sinergy Dashboard | Login</title>
  <!-- base:css -->
      ...
      <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              <div class="brand-logo">
                <img src="https://sinergydep.co.id/images/sdp-logo.png">
              </div>
          ...
          <?php date_default_timezone_set("Asia/Jakarta"); ?>
            <p class="text-white font-weight-medium text-center flex-grow align-self-end">Copyright &copy; <?= date('Y'); ?> Sinergy Dhawali Primeson.</p>
          </div>
        </div>
      </div>
